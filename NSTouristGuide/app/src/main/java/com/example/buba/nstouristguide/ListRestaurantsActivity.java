    ...
    private class getData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httppost = new HttpPost("http://nstouristguide.webtory.ch/get_restaurants.php"); //YOUR PHP SCRIPT ADDRESS
        ...
        protected void onPostExecute(String result) {
                ...
                mLocationListener = new LocationListener() {
                    ...
                    public void onLocationChanged(Location location) {
                        ...
                        CustomList adapter = new
                                CustomList(ListRestaurantsActivity.this, Data, ids, images, latitude, longitude, latLng);
            ...
            CustomList adapter = new
                    CustomList(ListRestaurantsActivity.this, Data, ids, images, latitude, longitude, test);
            list = (GridView) findViewById(R.id.gridView1);
            list.setAdapter(adapter);
